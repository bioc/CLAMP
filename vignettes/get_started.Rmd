...
The recovered LVs are biologically coherent for whole blood. LV2 is linked
to Ribosome and Proteasome programmes, reflecting the high protein turnover
characteristic of circulating blood cells. LV13 aligns with neutrophil
...
The significant LVs are well-aligned with Alzheimer's disease brain tissue.
LV3 and LV1 are strongly associated with GTEx gene expression profiles from
frontal cortex, substantia nigra, and spinal cord, confirming that the
dominant axes of variation reflect genuine neural transcriptional states
rather than technical noise. The presence of multiple brain-region-specific
signatures across a small number of LVs is consistent with the cellular and
regional heterogeneity expected in Alzheimer's disease bulk brain samples.
...
The significant LVs reflect known pancreatic islet biology. LV20 and LV16
correspond to opposing alpha- and beta-cell identity programmes, capturing
the major endocrine cell types of the islet. LV6 aligns with a
pancreas-specific GTEx tissue signature, confirming tissue identity. LV17
maps to TNF-alpha signalling via NF-kB, an inflammatory pathway central to
T2D pathogenesis. The results are biologically coherent and disease-relevant.
...
samples by condition (ND vs T2D), we compute average LV expression per group to
identify LVs that differ between healthy and diabetic islets
...
The differentially active LVs between T2D and ND donors are biologically
coherent with T2D pathogenesis. LV17, the top-ranked LV, is associated with
TNF-alpha signalling via NF-kB and interferon alpha and gamma response
programmes, canonical inflammatory pathways activated in islets under diabetic
conditions. LV9 maps to EBV-transformed lymphocyte signatures, consistent with
immune cell infiltration into islets during T2D progression. LV3 links to
whole-blood and diabetic mouse islet gene sets, suggesting a shared
inflammatory transcriptional signature between blood and affected islet tissue.
LV5 aligns with adipose tissue signatures, reflecting the metabolic context of
T2D. Together, the recovered programmes point to inflammation and immune
activation as the dominant axes distinguishing T2D from healthy donors.
