...
#' @noRd
#'
#' @importFrom stats cor sd var t.test smooth quantile median p.adjust coef setNames na.omit
#' @importFrom utils download.file data flush.console globalVariables
#' @importFrom Matrix Matrix sparseMatrix colSums colMeans t crossprod tcrossprod
