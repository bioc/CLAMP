...
#' Rows correspond to sample IDs and columns to major immune cell types. This dataset
#' can be used for validation or illustrative purposes in CLAMP analyses.
#'
